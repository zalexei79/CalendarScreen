...
export default function CalendarGrid({
  ...
  return (
    <section
      className={`flex-1 min-h-0 flex flex-col px-2 sm:px-8 pt-3 sm:py-6 pb-20 sm:pb-6 border-b relative transition-colors duration-200 ${isLight ? 'border-zinc-300' : 'border-zinc-800'}`}
